---
title: "Examen de práctica 2 (con soluciones) — 8.03SC Física III: Vibraciones y Ondas"
...
$$y(x) = \sum_{n=1}^{\infty} B_n\sin\frac{n\pi x}{L} \tag{1}$$

con

$$B_n = \frac{2}{L}\int_0^L f(x)\sin\frac{n\pi x}{L}\,dx \tag{2}$$
...
$$\frac{\partial^2\rho}{\partial t^2} = c^2\frac{\partial^2\rho}{\partial x^2} - \omega_p^2\rho \tag{1}$$

Sustituyendo $\rho(x, t) = a\sin(kx - \omega t)$, obtenemos

$$-\omega^2 = -c^2k^2 - \omega_p^2 \tag{2}$$

Por tanto,

$$\omega = \sqrt{c^2k^2 + \omega_p^2} \tag{3}$$

**b.**

$$k(\omega) = \frac{1}{c}\sqrt{\omega^2 - \omega_p^2} \tag{4}$$

La velocidad de fase:

$$v = \frac{\omega}{k} = \frac{c}{\sqrt{1 - \dfrac{\omega_p^2}{\omega^2}}} \tag{5}$$

La velocidad de grupo:

$$v = \left(\frac{dk}{d\omega}\right)^{-1} = c\sqrt{1 - \frac{\omega_p^2}{\omega^2}} \tag{6}$$

**c.** Sustituyendo $\rho(x, t) = a\cos(\omega t)e^{-\kappa x}$ en la ecuación de ondas, obtenemos

$$-\omega^2 = c^2\kappa^2 - \omega_p^2 \tag{7}$$

Por tanto,

$$\kappa = \frac{1}{c}\sqrt{\omega_p^2 - \omega^2} \tag{8}$$

## Solución del problema 2

**a.** La fuerza de tensión de la cuerda en la dirección vertical

$$T_y = T\left.\frac{dy}{dx}\right|_{x=0} \tag{9}$$

equilibra la fuerza externa $F(t)$. Por tanto, la condición de contorno es

$$F_0\sin(\omega t) + T\left.\frac{dy}{dx}\right|_{x=0} = 0 \tag{10}$$

**b.** La onda debe satisfacer la ecuación de ondas:

$$\frac{\partial^2 y}{\partial x^2} = \frac{1}{v^2}\frac{\partial^2 y}{\partial t^2} \tag{11}$$

donde $v^2 = \dfrac{T}{\mu}$. La solución compleja general con una sola frecuencia es

$$y = f\cos\left(\omega'\left(t - \frac{x}{v}\right) + \phi_1\right) + g\cos\left(\omega'\left(t + \frac{x}{v}\right) + \phi_2\right) \tag{12}$$
...
$$\lambda = \frac{2\pi v}{\omega} \tag{13}$$

**c.** No necesitamos conservar el término del pulso reflejado, así que basta con sustituir

$$y = f\cos\left(\omega\left(t - \frac{x}{v}\right) + \phi_1\right) \tag{14}$$

en la condición de contorno

$$F_0\sin(\omega t) + T\frac{\partial y}{\partial x} = 0 \tag{15}$$

con lo que tenemos

$$F_0\sin(\omega t) + \frac{Tf\omega}{v}\sin(\omega t + \phi_1) = 0 \tag{16}$$
...
$$y = \frac{F_0 v}{T\omega}\cos\left(\omega\left(t - \frac{x}{v}\right) + \pi\right) \tag{17}$$

con amplitud

$$A = \frac{F_0 v}{T\omega} \tag{18}$$

## Solución del problema 3

**a.** La condición de contorno es

$$\left.\frac{\partial y}{\partial x}\right|_{x=0} = 0 \tag{19}$$
...
$$y_m = \cos(k_m x)\ ,\qquad k_m = \left(m - \frac{1}{2}\right)\frac{\pi}{L} \quad (m = 1, 2, \ldots) \tag{23}$$

La frecuencia de un modo normal está relacionada con $k$ mediante

$$\omega = kv = k\sqrt{\frac{T}{\mu}} \tag{24}$$

Por tanto,

$$\omega_m = \left(m - \frac{1}{2}\right)\frac{\pi}{L}\sqrt{\frac{T}{\mu}} \tag{25}$$

$$\tau_m = \frac{2\pi}{\omega_m} = \frac{2L}{m - \frac{1}{2}}\sqrt{\frac{\mu}{T}} \tag{26}$$
...
$$\cos\frac{\left(m - \frac{1}{2}\right)\pi}{4} = 0 \tag{28}$$

o bien

$$\sin\frac{\left(m - \frac{1}{2}\right)\pi D}{2L} = 0 \tag{29}$$
...
$$\frac{\left(m - \frac{1}{2}\right)D}{2L} = p \tag{30}$$

sea un número entero.

**d.**

$$y(x, t) = \sum_{m=1}^{\infty} \frac{4H}{\pi\left(m - \frac{1}{2}\right)}\cos\frac{\left(m - \frac{1}{2}\right)\pi}{4}\,\sin\frac{\left(m - \frac{1}{2}\right)\pi D}{2L}\,\cos\left(\left(m - \frac{1}{2}\right)\frac{\pi x}{L}\right)\cos\left(\left(m - \frac{1}{2}\right)\frac{v\pi}{L}t\right) \tag{31}$$
...
$$\tau_1 = \frac{4L}{v}\ ,\qquad t = \frac{\tau_1}{2} = \frac{2L}{v} \tag{32}$$
...
$$\frac{\partial^2 y_L}{\partial x^2} = \frac{\mu}{T}\frac{\partial^2 y_L}{\partial t^2} \tag{33}$$

La ecuación de ondas a la derecha:

$$\frac{\partial^2 y_R}{\partial x^2} = \frac{\mu}{T}\frac{\partial^2 y_R}{\partial t^2} \tag{34}$$
...
$$T\left.\frac{\partial y_L}{\partial x}\right|_{x=0^-} = \frac{T}{2}\left.\frac{\partial y_R}{\partial x}\right|_{x=0^+} \tag{35}$$

Tenemos además la condición de continuidad:

$$y_L\big|_{x=0^-} = y_R\big|_{x=0^+} \tag{36}$$
...
$$r = \frac{1}{3}\ ,\qquad \mathrm{t} = \frac{4}{3} \tag{47}$$

En el contorno $x = L$ tenemos

$$g(L, t) + g_2(L, t) = 0 \tag{48}$$

de donde

$$r_2 = -\mathrm{t} = -\frac{4}{3} \tag{49}$$
...
$$y_1 = \sin(k_1 x)\ ,\qquad k_1 = \frac{\pi}{L} \tag{50}$$
...
$$\omega_1 = vk_1 = k_1\sqrt{\frac{TL}{M}} = \frac{\pi}{L}\sqrt{\frac{TL}{M}} \tag{52}$$

**b.** El $n$-ésimo modo tiene la forma

$$y_n = \sin(k_n x)\ ,\qquad k_n = \frac{n\pi}{L} \tag{53}$$

La longitud de onda

$$\lambda_n = \frac{2L}{n} \tag{54}$$

y la frecuencia

$$\omega_n = vk_n = k_n\sqrt{\frac{TL}{M}} = \frac{n\pi}{L}\sqrt{\frac{TL}{M}} \tag{55}$$

**c.** Los modos con $y_n(L/2) = 0$ serán cero, porque son antisimétricos respecto de $x = L/2$:

$$y_n(L/2 - x) = -y_n(L/2 + x) \tag{56}$$
...
$$y(x, t) = \sum_{n=1}^{\infty} B_n\sin\frac{n\pi x}{L}\cos\frac{n\pi vt}{L} \tag{57}$$
...
$$y_5(x, t) = B_5\sin\frac{5\pi x}{L}\cos\frac{5\pi v(t + L/4v)}{L} = B_5\sin\frac{5\pi x}{L}\cos\left(5\pi t\sqrt{\frac{T}{ML}} + \frac{5\pi}{4}\right) \tag{58}$$
...
$$f(x + L) = \sum_{m=1}^{20} B_m\sin\frac{(2m-1)\pi(x + L)}{L} = -\sum_{m=1}^{20} B_m\sin\frac{(2m-1)\pi x}{L} = -f(x) \tag{59}$$

mientras que la función $f(x)$ en el intervalo de $2L$ a $3L$ debe ser igual a la función $f(x)$ en el intervalo de $0$ a $L$:

$$f(x + 2L) = \sum_{m=1}^{20} B_m\sin\frac{(2m-1)\pi(x + 2L)}{L} = \sum_{m=1}^{20} B_m\sin\frac{(2m-1)\pi x}{L} = f(x) \tag{60}$$
...
$$y_1 = \sin(k_1 x)\ ,\qquad k_1 = \frac{\pi}{2L} \tag{61}$$
...
$$\omega_1 = vk_1 = k_1\sqrt{\frac{TL}{M}} = \frac{\pi}{2L}\sqrt{\frac{TL}{M}} \tag{63}$$

**i.** El $n$-ésimo modo tiene la forma

$$y_n = \sin(k_n x)\ ,\qquad k_n = \frac{(2n-1)\pi}{2L} \tag{64}$$

La longitud de onda

$$\lambda_n = \frac{4L}{2n-1} \tag{65}$$

y la frecuencia

$$\omega_n = vk_n = k_n\sqrt{\frac{TL}{M}} = \frac{(2n-1)\pi}{2L}\sqrt{\frac{TL}{M}} \tag{66}$$

**j.** En este caso, la función $f(x)$ en el intervalo de $L$ a $2L$ debe ser igual a la función $f(x)$ en el intervalo de $0$ a $L$:

$$f(2L - x) = \sum_{m=1}^{20} B_m\sin\frac{(2m-1)\pi(2L - x)}{2L} = \sum_{m=1}^{20} B_m\sin\frac{(2m-1)\pi x}{2L} = f(x) \tag{67}$$

mientras que la función $f(x)$ en el intervalo de $2L$ a $3L$ debe ser la opuesta de la función $f(x)$ en el intervalo de $0$ a $L$:

$$f(x + 2L) = \sum_{m=1}^{20} B_m\sin\frac{(2m-1)\pi(x + 2L)}{2L} = -\sum_{m=1}^{20} B_m\sin\frac{(2m-1)\pi x}{2L} = -f(x) \tag{68}$$

## Solución del problema 6

**a.** Las condiciones de contorno del campo eléctrico son

$$\vec{E}(0, t) = \vec{E}(L, t) = 0 \tag{69}$$

Por tanto, el $n$-ésimo modo normal es

$$E_y^{(n)}(z) = \sin\frac{n\pi z}{L} \tag{70}$$

$$E_y^{(n)}(z, t) = \sin\frac{n\pi z}{L}\cos\frac{n\pi ct}{L} \tag{71}$$

**b.** La onda estacionaria puede descomponerse en

$$E_y^{(n)}(z, t) = \sin\frac{n\pi z}{L}\cos\frac{n\pi ct}{L} = \operatorname{Re}\left[\frac{1}{2}e^{i\frac{n\pi}{L}(z - ct) - \frac{i\pi}{2}} + \frac{1}{2}e^{i\frac{n\pi}{L}(z + ct) - \frac{i\pi}{2}}\right] \tag{72}$$

Para una componente de onda viajera con vector de ondas unitario $\hat{k}$,

$$\vec{B} = \frac{1}{c}\hat{k} \times \vec{E} \tag{73}$$

Por tanto,

$$\vec{B} = \operatorname{Re}\left[\hat{z} \times \hat{y}\,\frac{1}{2}e^{i\frac{n\pi}{L}(z - ct) - \frac{i\pi}{2}} - \hat{z} \times \hat{y}\,\frac{1}{2}e^{i\frac{n\pi}{L}(z + ct) - \frac{i\pi}{2}}\right] = \frac{\hat{x}}{c}\cos\frac{n\pi z}{L}\sin\frac{n\pi ct}{L} \tag{74}$$

**c.**

$$\vec{S} = \frac{1}{\mu_0}\vec{E} \times \vec{B} = -\frac{\hat{z}}{\mu_0 c}\sin\frac{n\pi z}{L}\cos\frac{n\pi z}{L}\cos\frac{n\pi ct}{L}\sin\frac{n\pi ct}{L} \tag{75}$$

$$\langle\vec{S}\rangle = 0 \tag{76}$$

$$U_E = \frac{1}{2}\varepsilon_0\vec{E}^2 = \frac{1}{2}\varepsilon_0\sin^2\frac{n\pi z}{L}\cos^2\frac{n\pi ct}{L} \tag{77}$$

$$\langle U_E\rangle = \frac{1}{4}\varepsilon_0\sin^2\frac{n\pi z}{L} \tag{78}$$

$$U_B = \frac{1}{2\mu_0}\vec{B}^2 = \frac{1}{2\mu_0 c^2}\cos^2\frac{n\pi z}{L}\sin^2\frac{n\pi ct}{L} = \frac{1}{2}\varepsilon_0\cos^2\frac{n\pi z}{L}\sin^2\frac{n\pi ct}{L} \tag{79}$$

$$\langle U_B\rangle = \frac{1}{4}\varepsilon_0\cos^2\frac{n\pi z}{L} \tag{80}$$
...
$$\langle U_E + U_B\rangle = \frac{1}{4}\varepsilon_0 \tag{81}$$
