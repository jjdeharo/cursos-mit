---
title: "Examen de práctica 1 (con soluciones) — 8.03SC Física III: Vibraciones y Ondas"
...
$$y(t) = A\cos(\omega_0 t + \varphi) \tag{4}$$
...
$$E_p(t) = \frac{\big((1-\alpha)Mg\big)^2}{2k}\cos^2(\omega_0 t - \pi) \tag{7}$$

La energía cinética de la masa es $E_c = \frac{1}{2}\alpha M\dot{y}^2$, y

$$\dot{y}(t) = -\sqrt{\frac{k}{\alpha M}}\,\frac{(1-\alpha)Mg}{k}\sin(\omega_0 t - \pi) \tag{8}$$

de modo que

$$E_c(t) = \frac{\big((1-\alpha)Mg\big)^2}{2k}\sin^2(\omega_0 t - \pi) \tag{9}$$
...
$$\text{A:}\quad \ddot{x} = -\frac{k}{m}x - \frac{b}{m}\big(\dot{x} + \omega_d s_0\sin(\omega_d t)\big) \tag{10}$$

$$\text{B:}\quad \ddot{x} = -\frac{k}{m}\big(x - s_0\cos(\omega_d t)\big) - \frac{b}{m}\dot{x} \tag{11}$$

Así pues, reordenando para poner el término impulsor a la derecha,

$$\text{A:}\quad \ddot{x} + \Gamma\dot{x} + \omega_0^2 x = -\Gamma\omega_d s_0\sin(\omega_d t) \tag{12}$$

$$\text{B:}\quad \ddot{x} + \Gamma\dot{x} + \omega_0^2 x = \omega_0^2 s_0\cos(\omega_d t) \tag{13}$$
...
$$\text{A:}\quad \ddot{z} + \Gamma\dot{z} + \omega_0^2 z = -i\Gamma\omega_d s_0 e^{-i\omega_d t} \tag{14}$$

$$\text{B:}\quad \ddot{z} + \Gamma\dot{z} + \omega_0^2 z = \omega_0^2 s_0 e^{-i\omega_d t} \tag{15}$$

Sustituyendo nuestro ansatz en las ecuaciones del movimiento se obtiene

$$\text{A:}\quad \left(-\omega_d^2 - i\Gamma\omega_d + \omega_0^2\right)C = -i\Gamma\omega_d s_0 \tag{16}$$

$$\text{B:}\quad \left(-\omega_d^2 - i\Gamma\omega_d + \omega_0^2\right)C = \omega_0^2 s_0 \tag{17}$$

Reordenando, obtenemos

$$\text{A:}\quad C = -\frac{i\Gamma\omega_d s_0}{-\omega_d^2 - i\Gamma\omega_d + \omega_0^2} \tag{18}$$

$$\text{B:}\quad C = \frac{\omega_0^2 s_0}{-\omega_d^2 - i\Gamma\omega_d + \omega_0^2} \tag{19}$$
...
$$\text{A:}\quad C = -\frac{\left[i\left(\omega_0^2 - \omega_d^2\right) - \Gamma\omega_d\right]\Gamma\omega_d s_0}{\left(\omega_0^2 - \omega_d^2\right)^2 + \Gamma^2\omega_d^2} \tag{20}$$

$$\text{B:}\quad C = \frac{\left[\left(\omega_0^2 - \omega_d^2\right) + i\Gamma\omega_d\right]\omega_0^2 s_0}{\left(\omega_0^2 - \omega_d^2\right)^2 + \Gamma^2\omega_d^2} \tag{21}$$

La amplitud real de oscilación es el valor absoluto de la amplitud compleja:

$$\text{A:}\quad A = \frac{\Gamma\omega_d s_0}{\sqrt{\left(\omega_0^2 - \omega_d^2\right)^2 + \Gamma^2\omega_d^2}} \tag{22}$$

$$\text{B:}\quad A = \frac{\omega_0^2 s_0}{\sqrt{\left(\omega_0^2 - \omega_d^2\right)^2 + \Gamma^2\omega_d^2}} \tag{23}$$
...
$$\text{A:}\quad \frac{dA}{d\omega_d} = \frac{\Gamma s_0\left(\omega_0^4 - \omega_d^4\right)}{\left[\left(\omega_0^2 - \omega_d^2\right)^2 + \Gamma^2\omega_d^2\right]^{3/2}} \tag{24}$$

$$\text{B:}\quad \frac{dA}{d\omega_d} = \frac{-\omega_0^2 s_0\left(2\omega_d^2 - 2\omega_0^2 + \Gamma^2\right)\omega_d}{\left[\left(\omega_0^2 - \omega_d^2\right)^2 + \Gamma^2\omega_d^2\right]^{3/2}} \tag{25}$$

Igualando estas derivadas a cero y despejando $\omega_d$ se obtiene

$$\text{A:}\quad \omega_d = \pm\omega_0 \tag{26}$$

$$\text{B:}\quad \omega_d = 0,\ \pm\sqrt{\omega_0^2 - \frac{\Gamma^2}{2}} \tag{27}$$
...
$$M = \begin{pmatrix} m & 0 & 0 \\ 0 & 3m & 0 \\ 0 & 0 & m \end{pmatrix} \tag{28}$$

y la matriz $K$ es

$$K = \omega_0^2\begin{pmatrix} 2 & -1 & 0 \\ -1 & 2 & -1 \\ 0 & -1 & 2 \end{pmatrix} \tag{29}$$

donde $\omega_0^2 = \dfrac{k}{m}$, de modo que

$$\left[\omega_0^2\begin{pmatrix} 2 & -1 & 0 \\ -\frac{1}{3} & \frac{2}{3} & -\frac{1}{3} \\ 0 & -1 & 2 \end{pmatrix} - \omega^2 I\right]C = 0 \tag{30}$$
...
$$\left[\begin{pmatrix} \frac{g}{l} + \frac{k}{m} & -\frac{k}{m} & 0 \\ -\frac{k}{m} & \frac{g}{l} + \frac{4k}{m} & -\frac{3k}{m} \\ 0 & -\frac{3k}{m} & \frac{g}{l} + \frac{3k}{m} \end{pmatrix} - \omega^2 I\right]C = 0 \tag{31}$$
...
$$\left[\omega_0^2\begin{pmatrix} 4 & -3 & 0 & -1 \\ -3 & 4 & -1 & 0 \\ 0 & -1 & 4 & -3 \\ -1 & 0 & -3 & 4 \end{pmatrix} - \omega^2 I\right]C = 0 \tag{32}$$
...
$$I_2 = -\dot{Q}_1 - \dot{Q}_2 \tag{34}$$

$$I_3 = -\dot{Q}_1 - \dot{Q}_2 - \dot{Q}_3 \tag{35}$$
...
$$\frac{1}{LC}(Q_1 - Q_2) - \dot{I}_1 = 0 \tag{37}$$

$$\frac{1}{LC}(Q_2 - Q_3) - \dot{I}_2 = 0 \tag{38}$$

$$\frac{1}{LC}(Q_3 - Q_4) + \dot{I}_3 = 0 \tag{39}$$
...
$$\frac{1}{LC}(2I_1 - I_2) + \ddot{I}_1 = 0 \tag{40}$$

$$\frac{1}{LC}(2I_2 - I_1 - I_3) + \ddot{I}_2 = 0 \tag{41}$$

$$\frac{1}{LC}(2I_3 - I_2) + \ddot{I}_3 = 0 \tag{42}$$

$$\implies \left[\frac{1}{LC}\begin{pmatrix} 2 & -1 & 0 \\ -1 & 2 & -1 \\ 0 & -1 & 2 \end{pmatrix} - \omega^2 I\right]C = 0 \tag{43}$$

**(E)** Definiendo $x_n$ como la distancia horizontal respecto del equilibrio de la $n$-ésima masa contando desde arriba,

$$\ddot{x}_1 + \frac{5g}{L}x_1 - \frac{2g}{L}x_2 = 0 \tag{44}$$

$$\ddot{x}_2 + \frac{3g}{L}x_2 - \frac{2g}{L}x_1 - \frac{g}{L}x_3 = 0 \tag{45}$$

$$\ddot{x}_3 + \frac{g}{L}(x_3 - x_2) = 0 \tag{46}$$

de modo que

$$\left[\frac{g}{L}\begin{pmatrix} 5 & -2 & 0 \\ -2 & 3 & -1 \\ 0 & -1 & 1 \end{pmatrix} - \omega^2 I\right]C = 0 \tag{47}$$
